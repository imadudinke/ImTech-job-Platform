    ...
    <section className="grid sm:grid-cols-[0.2fr_1fr] grid-rows-[0.1fr_1fr] bg-gray-700 h-screen ">
      ...
      <div className="flex justify-between items-center gap-2 p-3 sm:px-10 bg-gray-900 text-white shadow-md">
        <div className="flex items-center sm:invisible">
          ...
          <p className="text-lg text-yellow-400 font-bold ml-2">ImTech</p>
        </div>

        <form action="#" className="w-[60%] sm:w-[50%] relative">
          <input
            type="text"
            placeholder="Search..."
            className="w-full p-2 pl-4 rounded-full bg-gray-800 border border-gray-700 text-white focus:ring-2 focus:ring-blue-500 outline-none"
          />
        ...
        <div className="flex items-center space-x-5">
          <i className="fa-regular fa-bell text-xl cursor-pointer hover:text-yellow-400"></i>
        ...
        {showSetting && (
          <div className="card--animate absolute bg-white text-black px-4 py-3 right-2 top-14 z-40 rounded-lg shadow-xl w-48 transition-all duration-200 transform scale-95 origin-top-right">
            <NavLink
