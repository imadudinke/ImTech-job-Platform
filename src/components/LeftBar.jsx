      ...
      <div className="text-white flex sm:flex-col px-3 gap-5 sm:justify-between mt-2 sm:px-2">
        {!who ? (
          ...
          <div className="flex sm:flex-col justify-between w-full sm:space-y-6 py-2 sm:py-10">
            ...
            <NavLink
              to="home"
              className="flex flex-col xsm:flex-row items-center xsm:gap-3 hover:bg-cyan-800 xsm:p-2 rounded-lg duration-300 p-1"
            >
              <i className="fa-solid fa-home text-xl"></i>
              <span className="text-[0.7rem] xsm:text-sm sm:text-lg">Home</span>
            </NavLink>

            {/* Jobs */}
            <NavLink
              to="job"
              className="flex flex-col xsm:flex-row items-center xsm:gap-3 hover:bg-cyan-800 p-1 xsm:p-2 rounded-lg duration-300"
            >
              <i className="fa-solid fa-briefcase text-xl"></i>
              <span className="text-[0.7rem] xsm:text-[1rem] text-nowrap sm:text-lg ">
                Applied Jobs
              </span>
            </NavLink>
            ...
            <NavLink
              to="application"
              className="flex flex-col xsm:flex-row items-center xsm:gap-3 hover:bg-cyan-800 xsm:p-2 rounded-lg duration-300"
            >
          ...
          <div className="flex sm:flex-col justify-between w-full sm:space-y-6 py-2 sm:py-10">
            ...
            >
              ...
              <span className="text-[0.6rem] xsm:text-[1rem] text-nowrap sm:text-lg ">
                Post Jobs
              </span>
            </NavLink>
            ...
            <NavLink
              ...
              className="flex flex-col xsm:flex-row items-center xsm:gap-3 hover:bg-cyan-800 xsm:p-2 rounded-lg duration-300"
            >
              <i className="fa-solid p-1  fa-list-check text-xl"></i>
              <span className="text-[0.6rem] xsm:text-[1rem] text-nowrap sm:text-lg ">
                Posted Jobs
              </span>
            </NavLink>
        ...
        <div className="py-2 hidden sm:flex sm:border-t-2">
          <NavLink
            to="/"
            className="flex items-center gap-3 asm:p-2 rounded-lg duration-300 hover:bg-red-600 p-1"
          >
